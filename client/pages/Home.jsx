...
const env = {
  ...
  heroSubtitle: import.meta.env.VITE_HERO_SUBTITLE || 'I build things for the web',
          ...
          <div className="hero__inner" ref={heroRef}>
            ...
            <h1 className="hero__name">
              {env.name.split(' ').map((word, i) => (
                <span key={i} className="hero__word" style={{ animationDelay: `${i * 0.1}s` }}>
                  {word}
                </span>
              ))}
            </h1>
            ...
            <div className="hero__actions">
              ...
              {env.github && (
                <a href={env.github} target="_blank" rel="noopener" className="btn btn--ghost">
                  GitHub
        ...
        <div className="container">
          <div className="contact-strip__inner">
            ...
            <div className="contact-strip__links">
              ...
              {env.github && <a href={env.github} target="_blank" rel="noopener" className="contact-link">GitHub</a>}
              {env.linkedin && <a href={env.linkedin} target="_blank" rel="noopener" className="contact-link">LinkedIn</a>}
            </div>
          </div>
        </div>
      </section>
